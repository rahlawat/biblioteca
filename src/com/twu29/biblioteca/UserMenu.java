...
public class UserMenu {
    ...
    private String[] menuItem = {"Login","List Of Books","Movie Catalog","Contact"};
    ...
    public String DisplayMenu() {
        ...
        String PrintMenu = "1. "+menuItem[0]+separator+"2. "+menuItem[1]+separator+"3. "+menuItem[2]+separator+"4. "+menuItem[3];
